...
- `NA` != `NaN`.
- Add discussion about double/single + stackoverflow examples: [https://stackoverflow.com/questions/6558921/difference-between-boolean-operators-and-and-between-and-in-r]
